        ...
        <div className="page relative z-10">
          ...
          <div className="border-2 border-[#F2F2F2]  mt-[4%] ml-[18%] mr-[18%] p-11  rounded-[50px] relative z-10  backdrop-blur-md ">
            ...
            <div className="text-center ">
              <h2 className="text-[#F2F2F2] mt-[7%] mb-5" >Create your account to get started</h2>
              <div className="flex justify-center items-center z-50 gap-5">
                <input placeholder='Email' type="text" className=" placeholder-[#fff] text-[#fff] pl-8 h-[60px] w-[400px] rounded-[100px] bg-black opacity-50 drop-shadow-2xl shadow-2xl backdrop-blur-3xl" />
          ...
          <div className='bg-gray ml-28 mt-16'>
            ...
            <div className='flex gap-12 mt-8 pl-12 pb-10 backdrop-blur-md'>
