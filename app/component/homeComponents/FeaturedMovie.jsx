...
const FeaturedMovie = ({
  ...
  return (
    ...
    <div className="mr-3 ml-3 relative bg-gray-900 rounded-[25px] overflow-hidden  shadow-lg text-white border-[3px] border-solid border-[#e6ad35]">
      ...
      <div className='relative w-[1250px] h-[550px] '><Image
        src={imageSrc}
        alt={title}
        fill
        objectFit='cover'
      ...
      <div className="absolute bottom-20 left-10 space-y-4">
        ...
        <div className="flex space-x-4">
          <Link href={filmDetailUrl} className="bg-[#D9D9D9] opacity-50 py-2 px-6 rounded-md text-black hover:opacity-80 flex flex-row gap-2 justify-center items-center">
          <FaInfoCircle size={30} color='#0C0C0C'/>
            Details
          </Link>
          <Link href={watchUrl} className="button-primary backprim flex flex-row justify-center items-center gap-2 ">
